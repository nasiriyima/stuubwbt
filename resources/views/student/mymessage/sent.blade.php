                                        ...
                                        <table class="table">
                                                ...
                                                @foreach($message_sent as $message)
                                                        <tr>
                                                                ...
                                                                <td>
                                                                        <a href="#">{!! ($message->status == 0)? '<strong>'.$message->receiver->first_name.'</strong>' : $message->receiver->first_name !!}</a>
                                                                </td>
                                                                <td class="hidden-sm"><a href="#">{!!  ($message->status == 0)? '<strong>'.$message->subject.'</strong>' : $message->subject !!}</a></td>
                                                                <td><a href="#"><span class="label label-{{ ($message->status == 0)? 'info' :(($message->status == 1)? 'success' : '') }}">{{ ($message->status == 0)? 'new' :(($message->status == 1)? 'read' : '') }}</span></a></td>
                                                                <td>
