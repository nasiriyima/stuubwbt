...
<div class="container">
        ...
        <div class="reg-block">
                <div class="reg-block-header">
                    ...
                    <br>
                    <h2>Sign Up</h2>
                    <p>Already Signed Up? Click <a class="color-green" href="{{url('web/sign-in')}}">Sign In</a> to login your account.</p>
                </div>
            @if(isset($message))
            ...
            @endif
            {!! Form::open(array('url' => url('auth/registration'),'class'=>'cd-form')) !!}
