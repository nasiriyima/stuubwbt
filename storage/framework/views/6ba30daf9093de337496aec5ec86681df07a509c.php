            ...
            <div class="row">
                <div class="col-md-5">
                    <form id="file-upload" action="<?php echo e(url('student/upload-profile-image')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <img class="img-responsive md-margin-bottom-10" width="259.58" height="259.58" src="<?php echo e(isset($user->profile->image)? url('student/file').'/'.$user->profile->image : asset('public/assets/img/team/img32-md.jpg')); ?>" alt="<?php echo e($user->first_name); ?>">
