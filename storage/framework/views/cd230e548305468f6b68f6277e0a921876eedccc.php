                                ...
                                <div class="panel-body">
                                                                                        ...
                                                                                        <section>
                                                                                                <label class="input">
                                                                                                        <select data-placeholder="To" multiple style="width: 906px;" class="chosen-select">
                                                                                                                <?php foreach($messageUser->friendship as $friend): ?>
                                        ...
                                        <form id="inboxMessages">
                                                <table class="table">
                                                        ...
                                                        <tbody>
                                                        <?php foreach($message_deleted as $message): ?>
                                                                <tr>
                                                                        ...
                                                                        <td>
                                                                                <a href="javascript:void(0)" onclick="showUndoModal('<?php echo e(\Crypt::encrypt($message->id)); ?>')" title="Undo"><span class="fa fa-undo"></span></a>
                                                                                <a href="javascript:void(0)" onclick="showDeleteModal('<?php echo e(\Crypt::encrypt($message->id)); ?>');" title="trash"><span class="fa fa-trash-o"></span></a>
                                                                                <input type="hidden" class="messages" id="message_id<?php echo e($message->id); ?>" name="messageId<?php echo e($message->id); ?>" value="<?php echo e(\Crypt::encrypt($message->id)); ?>"  disabled />
                                                                        </td>
                                                                </tr>
                                                        <?php endforeach; ?>
                                                        </tbody>
...
<?php $__env->startSection('pageplugins'); ?>
        ...
        <script type="text/javascript">
                ...
                function deleteMessage(){
                        ...
                        $.ajax({
                                url: "<?php echo url('student/force-delete'); ?>",
                                data: formdata,
                                method:"post",
                                success:function(response){
