                ...
                <div class="col-md-12">
                        ...
                        <div class="panel panel-red margin-bottom-40">
                                <div class="panel-heading">
                                        <h3 class="panel-title"><i class="fa fa-tasks"></i> Deleted</h3>
                                </div>
                                                ...
                                                <div class="modal-dialog">
                                                        <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                        <button type="button" class="btn-red btn-red-default" data-dismiss="modal">Cancel</button>
                                                                        <button type="button" class="btn-red btn-red">Send Message</button>
                                                                </div>
                                                        </div>
                                                </div>
                                        </div>
