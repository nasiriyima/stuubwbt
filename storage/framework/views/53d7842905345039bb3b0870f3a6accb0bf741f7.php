    ...
    <div class="panel-body">
        <form action="<?php echo e(url('student/edit-profile')); ?>" method="post" class="sky-form">
            ...
            <fieldset <?php echo e(($type == 'description')? '': 'style=display:none'); ?>>
                ...
                <section>
                    <img class="img-responsive md-margin-bottom-10" id="image_edit"  width="219.31" height="221.3" src="<?php echo e((isset($user->profile->image) && $user->profile->image !="" && $user->profile->image !=NULL)? url('student/file').'/profile_pictures/'.$user->profile->image : asset('public/assets/img/team/img32-md.jpg')); ?>" alt="<?php echo e($user->first_name); ?>">
