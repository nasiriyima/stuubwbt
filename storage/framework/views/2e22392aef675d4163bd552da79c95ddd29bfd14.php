                                                ...
                                                <table class="table">
                                                        ...
                                                        <?php foreach($message_saved as $message): ?>
                                                                <tr>
                                                                        ...
                                                                        <td>
                                                                                <a href="javascript:showEditMessage('<?php echo \Crypt::encrypt($message->id); ?>')"><?php echo ($message->status == 0)? '<strong>'.(isset($message->receiver->first_name))? $message->receiver->first_name : ''.'</strong>' : (isset($message->receiver->first_name))? $message->receiver->first_name : ''; ?></a>
                                                                        </td>
                                                                        <td class="hidden-sm">
                                                                                <a href="javascript:showEditMessage('<?php echo \Crypt::encrypt($message->id); ?>')"><?php echo ($message->status == 0)? '<strong>'.$message->subject.'</strong>' : $message->subject; ?></a>
                                                                        </td>
                                                                        <td>
                                                                                <a href="javascript:showEditMessage('<?php echo \Crypt::encrypt($message->id); ?>')"><span class="label label-<?php echo e(($message->status == 0)? 'info' :(($message->status == 1)? 'success' : '')); ?>"><?php echo e(($message->status == 0)? 'new' :(($message->status == 1)? 'read' : '')); ?></span></a>
                                                                        </td>
                                                                        <td>
        ...
        <script type="text/javascript">
                ...
                function showEditMessage(id){
                        $.ajax({
                                ...
                                method: 'post',
                                data: {_token:'<?php echo csrf_token(); ?>', id:id, action:'edit'},
