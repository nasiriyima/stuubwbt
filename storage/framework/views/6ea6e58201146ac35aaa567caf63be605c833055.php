                            ...
                            <div class="panel-body margin-bottom-40">
                                <ul class="timeline-v2 timeline-me">
                                    <?php foreach($leaders as $leader): ?>
                                        <li>
                                            <time datetime="" class="cbp_tmtime"><span>Last Seen</span> <span><?php echo e($leader->user->updated_at->diffForHumans()); ?></span></time>
                                            ...
                                            <div class="cbp_tmlabel">
                                                ...
                                                <p> Total Number of Attempts: <?php echo e($leader->user->history()->attempts($startDate, $endDate)->count()); ?></p>
