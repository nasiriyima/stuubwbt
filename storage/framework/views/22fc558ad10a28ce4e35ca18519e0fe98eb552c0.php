        ...
        <div class="panel panel-profile">
            ...
            <div class="panel-body">
                ...
                <?php if(count($requests) < 1): ?>
                    You have no friendship requests. <?php if(!isset($user->profile->social_contact) || $user->profile->social_contact == NULL || $user->profile->social_contact == ""): ?> Add your social contact information to invite your friends from facebook, google-plus and twitter <?php endif; ?>
                <?php endif; ?>
