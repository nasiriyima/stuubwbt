                        ...
                        <table class="table">
                            ...
                            <?php foreach($message_sent as $message): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:showMessage('<?php echo \Crypt::encrypt($message->id); ?>')"><?php echo ($message->status == 0)? '<strong>'.$message->receiver->first_name.'</strong>' : $message->receiver->first_name; ?></a>
                                    </td>
                                    <td class="hidden-sm">
...
<?php $__env->startSection('pageplugins'); ?>
    ...
    <script type="text/javascript">
        ...
        function showMessage(id){
            $.ajax({
                url: '<?php echo url('admin/message-view'); ?>',
        ...
        function replyShowMessage(id){
            $.ajax({
                url: '<?php echo url('admin/message-details'); ?>',
                method: 'post',
        ...
        function deleteMessage(){
            ...
            $.ajax({
                url: "<?php echo url('admin/delete-message'); ?>",
                data: formdata,
                method:"post",
                success:function(response){
                    var obj = JSON.parse(response);
