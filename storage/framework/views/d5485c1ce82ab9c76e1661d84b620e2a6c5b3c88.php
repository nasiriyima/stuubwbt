...
<script type="text/javascript" src="<?php echo e(asset('public/assets/plugins/modernizr.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('public/assets/plugins/login-signup-modal-window/js/main.js')); ?>"></script>
